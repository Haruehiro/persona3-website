...
const ITEMS = [
  ...
  {
    id: "instagram", label: "INSTAGRAM", handle: "@looksunedited", href: "https://www.instagram.com/looksunedited/", icon: "📷", barIcon: icon2, bars: 1, newBars: [], counts: [""],
    links: ["www.instagram.com/looksunedited/"],
    stats: [
  ...
  {
    id: "tiktok", label: "TIKTOK", handle: "@haruehiro", href: "https://www.tiktok.com/@haruehiro", icon: "🎵", barIcon: icon3, bars: 1, newBars: [], counts: [""],
    links: ["www.tiktok.com/@haruehiro"],
    stats: [
      { tag: "FOL", value: "", color: "#00f2ea" },
      { tag: "LKS", value: "", color: "#ff0050" },
    ],
  },
];
