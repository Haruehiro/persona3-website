...
const ITEMS = [
  ...
  { id: "gallery",  label: "GALLERY",       page: "gallery", fontSize: 70, offsetX: 10, offsetY: 6,  skew: -4,  skewY: 7   },
];
...
export default function P3Menu({ onNavigate }) {
  ...
  useEffect(() => {
    const onKey = (e) => {
      ...
      if (e.key === "Enter") {
        if (ITEMS[active].id === "github") window.open("https://github.com/Haruehiro", "_blank");
          ...
          {ITEMS.map((item, i) => {
            ...
            return (
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  if (item.id === "github") window.open("https://github.com/Haruehiro", "_blank");
